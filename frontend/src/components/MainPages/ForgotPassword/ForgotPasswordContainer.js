...
//import forgotPassword from '../../../reducers/userReducers';
import ForgotPassword from '../../forgot.password/forgot.password';
import OTP from '../../forgot.password/otp';
import Fail from '../../Status/fail';
import Success from '../../Status/success';
import EnterNewPassword from '../../forgot.password/enter.newPassword';
...
const mapStateToProps = state => ({
    isForgot: state.forgotPassword.isForgot,
    verify_otp: state.forgotPassword.verify_otp,
